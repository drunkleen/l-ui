...
export const ClientPageResponseSchema = z.object({
  items: z.array(ClientSlimSchema).nullable().transform((v) => v ?? []),
  total: z.number(),
  filtered: z.number(),
  page: z.number(),
  pageSize: z.number(),
...
export const ClientMoveReportSchema = z.object({
  email: z.string(),
  reason: z.string(),
});

export const ClientMoveResultSchema = z.object({
  moved: z.array(z.string()).nullable().transform((v) => v ?? []),
  skipped: z.array(ClientMoveReportSchema).nullable().transform((v) => v ?? []),
  errors: z.array(ClientMoveReportSchema).nullable().transform((v) => v ?? []),
});
...
export type ClientMoveReport = z.infer<typeof ClientMoveReportSchema>;
export type ClientMoveResult = z.infer<typeof ClientMoveResultSchema>;
