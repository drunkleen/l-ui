...
export default function XrayPage() {
  ...
  const xs = useXraySetting({ enabled: !isHubMode });
  const {
    fetched,
    spinning,
    saveDisabled,
        ...
        <Layout className={pageClass}>
          ...
          <Layout className="content-shell">
            <Layout.Content className="content-area">
              <Result
                status="info"
                title="Xray controls are available on agent nodes"
                subTitle="This hub manages remote nodes and does not run a local Xray instance. Open a node to reinstall, rotate credentials, or reconcile runtime state."
