...
const PANEL_VERSION = process.env.L_UI_VERSION || '3.x';
...
function buildSpec() {
  ...
  return {
    openapi: '3.0.3',
    info: {
      title: 'L-UI Panel API',
      version: PANEL_VERSION,
      description:
        'Programmatic interface to a L-UI panel. Authenticate either by logging in (cookie) or with an API token from Settings → Security → API Token (Bearer). All endpoints under /panel/api/* honour both modes.',
    },
    servers: [
